...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Exclude the mappings you want for yourself (default: None)
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
if !exists('g:spacevim_exclude')
...
if match(g:spacevim_exclude, '0') < 0
...
" applications {{{
if match(g:spacevim_exclude, 'a') < 0
...
" buffers {{{
if match(g:spacevim_exclude, 'b') < 0
...
" comile/comments {{{
if match(g:spacevim_exclude, 'c') < 0
...
" errors {{{
if match(g:spacevim_exclude, 'e') < 0
...
" files {{{
if match(g:spacevim_exclude, 'f') < 0
...
if match(g:spacevim_exclude, 'g') < 0
...
" help/highlight {{{
if match(g:spacevim_exclude, 'h') < 0
  let g:lmap.h = { 'name' : '+help/highlight' }
endif
" }}}

" insertion {{{
if match(g:spacevim_exclude, 'i') < 0
...
" join/split {{{
if match(g:spacevim_exclude, 'j') < 0
...
" lisp {{{
if match(g:spacevim_exclude, 'k') < 0
  let g:lmap.k = { 'name' : '+lisp' }
endif
" }}}

" narrow/numbers {{{
if match(g:spacevim_exclude, 'n') < 0
...
" projects {{{
if match(g:spacevim_exclude, 'p') < 0
...
" quit {{{
if match(g:spacevim_exclude, 'q') < 0
...
" registers/rings {{{
if match(g:spacevim_exclude, 'r') < 0
  let g:lmap.r = { 'name' : '+registers/rings' }
endif
" }}}

" search/symbol {{{
if match(g:spacevim_exclude, 's') < 0
...
" toggles {{{
if match(g:spacevim_exclude, 't') < 0
...
" windows {{{
if match(g:spacevim_exclude, 'w') < 0
...
" text {{{
if match(g:spacevim_exclude, 'x') < 0
  let g:lmap.x = { 'name' : '+text' }
endif
" }}}

if match(g:spacevim_exclude, 'y') < 0
...
" zoom {{{
if match(g:spacevim_exclude, 'z') < 0
